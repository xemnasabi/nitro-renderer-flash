...
export interface IUserDataManager
{
    ...
    updateLevel(roomIndex: number, level: string): void;
    updateRespects(roomIndex: number, respects: string): void;
    updateOnlineTime(roomIndex: number, onlinetime: string): void;
    updateInstagram(roomIndex: number, instagram: string): void;
    updateDiscord(roomIndex: number, discord: string): void;
    updateTwitter(roomIndex: number, twitter: string): void;
    updateFacebook(roomIndex: number, facebook: string): void;
    updateTikTok(roomIndex: number, tiktok: string): void;
    updateVerified(roomIndex: number, verified: string): void;
