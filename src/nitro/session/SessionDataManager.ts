...
export class SessionDataManager extends NitroManager implements ISessionDataManager
{
    ...
    private _userVoiceChatApiKey: string;
    ...
    constructor(communication: INitroCommunicationManager)
    {
        ...
        this._userVoiceChatApiKey = null;
    ...
    protected onInit(): void
    {
        ...
        this.events && this.events.dispatchEvent(new FurnitureDataEventLoading(FurnitureDataEventLoading.LOADING));
        ...
        this._communication.registerMessageEvent(new UserVoicechatMessageApiKey(this.onUserVoiceChatApiKeyEvent.bind(this)));
    ...
    private onUserVoiceChatApiKeyEvent(event: UserVoicechatMessageApiKey): void
    {
        if(!event || !event.connection) return;

        this._userVoiceChatApiKey = event.getParser().voiceChatApiKey;
    ...
    public get userVoiceChatApiKey(): string
    {
        return this._userVoiceChatApiKey;
    }

    public get isModerator(): boolean
    {
        return (this._securityLevel >= SecurityLevel.EMPLOYEE);
    }
