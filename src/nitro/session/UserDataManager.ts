...
export class UserDataManager extends Disposable
{
    ...
    public updateRespects(roomIndex: number, respects: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);

        if(!userData) return;

        userData.respects = respects;
    }

        
    public updateLevel(roomIndex: number, level: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateOnlineTime(roomIndex: number, onlinetime: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);

        if(!userData) return;

        userData.onlinetime = onlinetime;
    }


    public updateInstagram(roomIndex: number, instagram: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateDiscord(roomIndex: number, discord: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateTwitter(roomIndex: number, twitter: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateFacebook(roomIndex: number, facebook: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateTikTok(roomIndex: number, tiktok: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
    ...
    public updateVerified(roomIndex: number, verified: string): void
    {
        const userData = this.getUserDataByIndex(roomIndex);
