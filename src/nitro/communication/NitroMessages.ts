...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        this._events.set(IncomingHeader.FLOOD_TRANSLATE_CONTROL, FloodTranslateControlEvent);
        ...
        this._events.set(IncomingHeader.VOICECHAT_API_USER_KEY, UserVoicechatMessageApiKey);
